...
export type ImageElement = { type: 'image'; url: string; height: number; width: number, children: CustomText[] };
...
export type CustomElement = ParagraphElement | ImageElement | HeadingElement | LinkElement;
